...
- [PROJECT_STRUCTURE.md](../PROJECT_STRUCTURE.md) - **正式なディレクトリツリー**（構成の基準・管理しやすいツリー）
- [replit.md](../replit.md) - システムアーキテクチャ・技術仕様・設計原則（任意）
- [ENV_VARIABLES_CHECKLIST.md](./ENV_VARIABLES_CHECKLIST.md) - 環境変数一覧
- [STARTUP_CHECK.md](./STARTUP_CHECK.md) - 起動確認手順
- [PRODUCTION_READINESS.md](./PRODUCTION_READINESS.md) - 本番展開・高速稼働基準
...
### 検証・移行・週次（docs 直下）
- [REFACTOR_VERIFICATION_REPORT.md](./REFACTOR_VERIFICATION_REPORT.md) - リファクタ整合性検証
- [LIBRAL_CORE_MIGRATION_STRATEGY.md](./LIBRAL_CORE_MIGRATION_STRATEGY.md) - Python コア移行戦略
- [TELEGRAM_PERSONAL_LOG_PROTOCOL.md](./TELEGRAM_PERSONAL_LOG_PROTOCOL.md) - Telegram パーソナルログ
- [TELEGRAM_TOPICS_HASHTAGS_IMPROVEMENT_REPORT.md](./TELEGRAM_TOPICS_HASHTAGS_IMPROVEMENT_REPORT.md) - トピック・ハッシュタグ改善
- [reports](./reports) - プラグインマーケットプレース完了報告（拡張子なし）
...
- [MODULE_CREATION.md](./MODULE_CREATION.md) - モジュール作成ガイド（テンプレート付き）
- [MODULE_CONTRACT.md](./MODULE_CONTRACT.md) - モジュール契約（IStorage, StampModule, TransportAdapter）
- [MODULE_REGISTRY.md](./MODULE_REGISTRY.md) - レジストリ運用・交換手順

### 監査・アップデート提案
- [AUDIT_AND_UPDATE_PROPOSAL.md](./AUDIT_AND_UPDATE_PROPOSAL.md) - コード分析・脆弱性・依存関係・将来拡張のアップデート提案（最先端リサーチ反映）
