    ...
    <div className="relative min-h-screen bg-[#080A0F] overflow-hidden" style={{ fontFamily: 'Share Tech Mono, monospace' }}>
      ...
      <div 
        ...
        style={{
          ...
          borderRight: '2px solid #FFEB00',
          boxShadow: doorOpen ? 'none' : '0 0 30px #FFEB00'
        }}
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-[#FFEB00] text-6xl font-bold animate-pulse">L</div>
        </div>
      </div>
      ...
      <div 
        ...
        style={{
          ...
          borderLeft: '2px solid #FFEB00',
          boxShadow: doorOpen ? 'none' : '0 0 30px #FFEB00'
        }}
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-[#FFEB00] text-6xl font-bold animate-pulse">C</div>
        </div>
      </div>
        ...
        <header className="relative px-8 py-6 border-b border-[#FFEB00]/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-[#FFEB00] text-2xl font-bold tracking-[0.2em]" style={{ fontFamily: 'Major Mono Display, monospace' }}>LIBRAL CORE</h1>
                <p className="text-[#FFEB00]/60 text-xs tracking-[0.3em]">C3 CONSOLE - CONTEXT COMMAND CENTER</p>
              </div>
            </div>
            
            <div className="flex items-center gap-4">
              <div className="text-[#FFEB00]/60 text-sm tracking-wider">[系統-連続]</div>
              <div className="flex gap-1">
                {[...Array(5)].map((_, i) => (
                  <div key={i} className={`w-2 h-2 ${i < 4 ? 'bg-[#FFEB00]' : 'bg-[#FFEB00]/20'}`} />
                ))}
              </div>
            </div>
          </div>
        ...
        <main className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-6xl">
            <div className="text-center mb-16">
              <div className="inline-block mb-4 px-6 py-2 border border-[#FFEB00]/50"
                   style={{ clipPath: 'polygon(10% 0%, 90% 0%, 100% 50%, 90% 100%, 10% 100%, 0% 50%)' }}>
                <h2 className="text-[#FFEB00] text-sm tracking-[0.4em]">SYSTEM STATUS</h2>
              </div>
              <div className="text-white/80 text-lg tracking-[0.2em] mb-8">S07.K - メイン制御インターフェース</div>
              
              <div className="flex items-center justify-center gap-8 mb-8">
                <div className="flex flex-col items-center">
                  <div className="w-20 h-1 bg-[#FFEB00] mb-2 relative overflow-hidden">
                  ...
                  <span className="text-[#FFEB00]/60 text-xs">ONLINE</span>
                </div>
                <div className="text-[#FFEB00] text-4xl">●</div>
                <div className="flex flex-col items-center">
                  <div className="w-20 h-1 bg-[#FFEB00] mb-2 relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent animate-[shimmer_2s_infinite]" />
                  </div>
                  <span className="text-[#FFEB00]/60 text-xs">READY</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <button
                ...
                className="group relative p-8 border-2 border-[#FFEB00]/50 hover:border-[#FFEB00] transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,209,0.3)]"
                style={{ clipPath: 'polygon(0 0, calc(100% - 20px) 0, 100% 20px, 100% 100%, 20px 100%, 0 calc(100% - 20px))' }}
                data-testid="button-apps"
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-16 h-16 border-2 border-[#FFEB00] flex items-center justify-center group-hover:bg-[#FFEB00] group-hover:text-[#080A0F] transition-all"
                       style={{ clipPath: 'polygon(30% 0%, 70% 0%, 100% 30%, 100% 70%, 70% 100%, 30% 100%, 0% 70%, 0% 30%)' }}>
                    <Grid3x3 className="w-8 h-8" />
                  </div>
                  <div className="text-left flex-1">
                    <h3 className="text-[#FFEB00] text-xl font-bold tracking-[0.2em] mb-1">BUTTON 01</h3>
                    <p className="text-[#FFEB00]/60 text-sm">D008</p>
                  </div>
                ...
                <div className="absolute bottom-4 right-4 text-[#FFEB00]/30 text-xs">/// APPS &amp; FEATURES</div>
              </button>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="text-left flex-1">
                    <h3 className="text-[#FFEB00] text-xl font-bold tracking-[0.2em] mb-1">BUTTON 02</h3>
                    <p className="text-[#FFEB00]/60 text-sm">D034</p>
                  </div>
                  <div className="text-[#FFEB00] text-2xl group-hover:translate-x-2 transition-transform">▶</div>
                </div>
                <p className="text-white/70 text-sm tracking-wide">コンソールメニュー & システム制御</p>
                <div className="absolute bottom-4 right-4 text-[#FFEB00]/30 text-xs">/// CONSOLE MENU</div>
              </button>
            </div>
            ...
            <div className="mt-12 relative">
              <div className="border border-[#FFEB00]/30 p-6"
                ...
                <div className="flex items-center gap-2 mb-4">
                  <div className="text-[#FFEB00] text-sm tracking-[0.3em]">INFO</div>
                  <div className="flex-1 h-px bg-[#FFEB00]/30" />
                  <div className="text-[#FFEB00]/60 text-xs">▶</div>
                </div>
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    <Shield className="text-[#FFEB00] w-4 h-4" />
                    <span className="text-white/60">Security: </span>
                    <span className="text-[#FFEB00]">ACTIVE</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Activity className="text-[#FFEB00] w-4 h-4" />
                    <span className="text-white/60">Modules: </span>
                    <span className="text-[#FFEB00]">6 ONLINE</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Settings className="text-[#FFEB00] w-4 h-4" />
                    <span className="text-white/60">Status: </span>
                    <span className="text-[#FFEB00]">OPERATIONAL</span>
                  </div>
                </div>
              </div>
            </div>
