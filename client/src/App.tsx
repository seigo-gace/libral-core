...
import C3Layout from "@/layouts/C3Layout";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/c3/apps/:moduleId" component={C3Layout} />
      <Route path="/c3/apps" component={C3Layout} />
      <Route path="/c3/console" component={C3Layout} />
      <Route path="/c3" component={C3Layout} />
