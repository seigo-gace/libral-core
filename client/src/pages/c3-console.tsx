    ...
    <div className="relative min-h-screen bg-[black] overflow-hidden font-mono">
        ...
        <header className="relative px-8 py-6 border-b border-[white]/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-[white] text-xl font-bold tracking-[0.2em]">CONSOLE MENU</h1>
                <p className="text-[white]/60 text-xs tracking-[0.3em]">SYSTEM CONTROL & MONITORING</p>
              </div>
            </div>
            
            <div className="flex items-center gap-4">
              <div className="text-[white]/60 text-sm tracking-wider">[D034]</div>
            </div>
          </div>
        </header>
        ...
        <main className="flex-1 p-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-6 mb-8">
              <div className="border border-[white]/30 p-6"
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-[white] tracking-wider">CPU USAGE</h3>
                </div>
              ...
              <div className="border border-[white]/30 p-6"
                ...
                <div className="flex items-center gap-3 mb-4">
                  <Activity className="text-[white]" />
                  <h3 className="text-[white] tracking-wider">MEMORY</h3>
                </div>
              ...
              <div className="border border-[white]/30 p-6"
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-[white] tracking-wider">ACTIVE USERS</h3>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 border-2 border-[#FF3A5B] flex items-center justify-center group-hover:bg-[#FF3A5B] group-hover:text-[black] transition-all"
            ...
            <div className="border border-[white]/30 p-6"
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-[white] tracking-wider">SYSTEM LOG</h3>
              </div>
      ...
      {showConfirmModal && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50" data-testid="modal-confirm">
          <div className="bg-[black] border-2 border-[#FF3A5B] p-8 max-w-md w-full"
               style={{ clipPath: 'polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)' }}>
            ...
            <input
              ...
              className="w-full bg-[black] border border-[white]/50 text-[white] px-4 py-3 mb-6 font-mono focus:outline-none focus:border-[white]"
              placeholder="CONFIRM"
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 px-4 py-3 border border-[white]/50 text-[white] hover:bg-[white]/10 transition-all"
              ...
              <button
                ...
                className={`flex-1 px-4 py-3 border-2 transition-all ${
                  confirmCode === "CONFIRM"
                    ? "border-[#FF3A5B] text-[#FF3A5B] hover:bg-[#FF3A5B] hover:text-[black]"
